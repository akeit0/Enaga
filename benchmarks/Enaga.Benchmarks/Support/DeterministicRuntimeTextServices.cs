...
internal sealed class DeterministicRuntimeTextServices : IRuntimeTextServices
{
    ...
    {
        var charWidth = style.Font.Size * (style.Font.Weight >= 600 ? 0.62f : 0.58f);
        ...
        var count = Math.Clamp((int)MathF.Floor(maxWidth / charWidth), 0, content.Length);
