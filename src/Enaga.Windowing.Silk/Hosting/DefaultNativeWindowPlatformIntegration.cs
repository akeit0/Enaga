...
public sealed class DefaultNativeWindowPlatformIntegration : INativeWindowPlatformIntegration
{
    ...
    private static void ConfigurePlatformFonts()
    {
        ...
        {
            NativeTextConfiguration.ConfigureFonts("Helvetica Neue", "Arial Unicode MS", "Hiragino Sans", "Apple Color Emoji");
            return;
        }

        NativeTextConfiguration.ConfigureFonts("DejaVu Sans", "Noto Sans", "Noto Sans CJK JP", "Liberation Sans", "Noto Color Emoji");
    }
}
