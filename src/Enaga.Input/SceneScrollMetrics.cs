...
public static class SceneScrollMetrics
{
    ...
    public static float MaxScrollY(SceneLayoutBox box)
        => MaxScrollY(box.Height, box.ContentHeight);
    ...
    public static float MaxScrollX(float viewportWidth, float contentWidth, bool horizontalScrollEnabled)
    ...
    public static float ClampScrollX(float scrollX, float viewportWidth, float contentWidth, bool horizontalScrollEnabled)
    ...
    {
        var nextScrollX = ClampScrollX(scrollX + deltaX * wheelScrollFactor, viewportWidth, contentWidth, horizontalScrollEnabled);
        var nextScrollY = ClampScrollY(scrollY - deltaY * wheelScrollFactor, viewportHeight, contentHeight);
        return Math.Abs(nextScrollX - scrollX) > 0.001f ||
               Math.Abs(nextScrollY - scrollY) > 0.001f;
    }
}
