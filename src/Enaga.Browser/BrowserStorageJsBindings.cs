...
internal static class BrowserStorageJsBindings
{
    ...
    public static JsPlainObject CreateStorageObject(JsRealm realm, BrowserStorageArea storage)
    {
        ...
        obj.DefineAccessorProperty(
            ...
            new JsHostFunction(
                realm,
                (in CallInfo _) => JsValue.FromInt32(storage.Length),
                "get length",
                0
            ),
            null,
                ...
                new JsHostFunction(
                    ...
                    (in CallInfo info) =>
                    {
                        var index = info.GetArgumentOrDefault(0, JsValue.Undefined).IsNumber
                            ...
                            : -1;
                        return storage.Key(index) is { } key
        ...
        obj.DefineDataProperty(
            ...
            JsValue.FromObject(
                new JsHostFunction(
                    ...
                    (in CallInfo info) =>
                    {
                        var key = JsValueToStorageString(
                            info.GetArgumentOrDefault(0, JsValue.Undefined)
                        );
                        return storage.GetItem(key) is { } value
            ...
            JsValue.FromObject(
                new JsHostFunction(
                    ...
                    (in CallInfo info) =>
                    {
                        ...
                        var value = JsValueToStorageString(
